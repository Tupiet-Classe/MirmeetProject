                ...
                <div class="p-6 text-gray-900">
                    <div id="margin_table">
                        ...
                        <div class="flex justify-between">
                            <form class="flex" action="{{ route('manage.search') }}" method="GET">
                                <label for="searchManage" class="mb-2 text-sm font-medium text-gray-900 sr-only">Search</label>
                                <div class="relative">
                        ...
                        <div class="shadow-md mt-4 relative overflow-x-auto rounded-lg">
