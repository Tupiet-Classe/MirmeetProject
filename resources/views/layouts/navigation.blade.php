    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            ...
            <ul
                ...
                <li>
                    <button @click="setLocale('en')" class="language-button block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent text-xs">EN</button>
                </li>
                <li>
...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('users.index')" :active="Str::startsWith(
                        request()
                            ->route()
                            ->getName(),
                        ['users.', 'manage.'],
                    ...
                    @can('dashboard.validate.users')
                        <x-nav-link :href="route('pending.users')" :active="Str::startsWith(
                            request()
                                ->route()
                                ->getName(),
                            ['pending.', 'denied.'],
                    ...
                    @can('dashboard.manage.users')
                        <x-nav-link :href="route('ban.users')" :active="Str::startsWith(
                            request()
                                ->route()
                                ->getName(),
                            ['ban.', 'manage.'],
                    ...
                    @can('dashboard.verify.users')
                        <x-nav-link :href="route('verify.users')" :active="Str::startsWith(
                            request()
                                ->route()
                                ->getName(),
                            ['verify.'],
                    ...
                    @can('dashboard.roles')
                        <x-nav-link :href="route('roles.users')" :active="Str::startsWith(
                            request()
                                ->route()
                                ->getName(),
                            ['role.', 'roles.'],
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @can('dashboard.validate.users')
                <x-responsive-nav-link :href="route('pending.users')" :active="Str::startsWith(
                    request()
                        ->route()
                        ->getName(),
                    ['pending.', 'denied.'],
            ...
            @can('dashboard.manage.users')
                <x-responsive-nav-link :href="route('ban.users')" :active="Str::startsWith(
                    request()
                        ->route()
                        ->getName(),
                    ['ban.', 'manage.'],
            ...
            @can('dashboard.verify.users')
                <x-responsive-nav-link :href="route('verify.users')" :active="Str::startsWith(
                    request()
                        ->route()
                        ->getName(),
                    ['verify.'],
            ...
            @can('dashboard.roles')
                <x-responsive-nav-link :href="route('roles.users')" :active="Str::startsWith(
                    request()
                        ->route()
                        ->getName(),
                    ['role.', 'roles.'],
